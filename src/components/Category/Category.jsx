    ...
    return (
      ...
      <div className="flex-1 basis-[300px] " key={card.id}>
        ...
        <div className="bg-zinc-100 pt-17 p-8 rounded-xl">
          ...
          text-white px-8 py-3 rounded-lg md:text-lg text-md hover:scale-105 hover:to-orange-500 
...
const category = [
  {
    ...
    description:
      "Fresh, organic prodice sourced daily from local farms. Explore a wide range of seasonal fruits and crisp vegatable ",
    image: FruitsCat,
    path: "/fruits",
  },
  {
    ...
    title: "Dairy & Eggs",
    description:
      "Wholessome dairy products and free-range eggs. From cramy milk and yogurt to artisanal cheeses.",
    image: DairyCat,
    path: "/dairy",
  },
  {
